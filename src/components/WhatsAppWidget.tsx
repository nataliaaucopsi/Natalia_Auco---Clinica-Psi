...
export default function WhatsAppWidget() {
  ...
  return (
    <div className="wa-widget-container" id="whatsapp-widget-root">
      
      {/* WhatsApp Chat Window */}
      <div className={`wa-chat-window ${isOpen ? 'is-open' : ''}`} id="waChatWindow">
        <div className="wa-header">
          ...
          <div className="wa-info">
            <span className="wa-name">Natália Auco</span>
      ...
      >
        ...
        {showDot && <div className="wa-notification-dot" id="waDot"></div>}
      </button>
